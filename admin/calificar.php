...
<head>
    ...
    <link href="assets/css/Cronometro.css" rel="stylesheet" type="text/css" />
</head>
                ...
                <div class="container-fluid">
                    ...
                    <div id="yourContainerId">
                           <div class="cronometro" style="display: none;">
                             <?php  include_once("./src/cronometro.php") ?>  
                        </div>
                        ...
                        <div class="modal-dialog" role="document" style="background-color: #5e5e5e !important; padding: 10px 20px 30px 20px !important;">
                            <div class="modal-content">
                                ...
                                <div class="modal-body" style="padding: 30px;">
                                    ...
                                    <form id="modalForm" style="padding: 10px;" enctype="multipart/form-data">
