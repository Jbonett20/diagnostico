                                                ...
                                                foreach ($eventos as $key => $value) { ?>
                                                    <tr class="evento-row" data-estadoid="<?php echo $value['estadoid']; ?>">
                                                        ...
                                                        <td class="text-center">
                                                            <?php
                                                            if ($value['estadoid'] == 1) {
                                                                echo '<span class="badge label-table badge-success">Activo</span>';
                                                            } elseif ($value['estadoid'] == 2) {
                                                                echo '<span class="badge label-table badge-danger">Cancelado</span>';
                                                            } elseif ($value['estadoid'] == 3) {
                                                                echo '<span class="badge label-table badge-warning">En proceso</span>';
                                                        ...
                                                        <td class="text-center">
                                                            <button class="btn btn-sm btn-secondary btn-xs btn-min" onclick="ActivarEvento(<?php echo $value['eventoid'] ?>)">Activar Evento</button>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <div class="d-flex justify-content-center">
                                                                ...
                                                                if ($value['estadoid'] == 3) { ?>
                                                                    ...
                                                                    <span class="action-icon" onclick="eliminarEvento(<?php echo $value['eventoid'] . ',' . $value['estadoid']; ?>)"><i class="fas fa-trash-alt" style="color:#ab2b3e"></i></span>
